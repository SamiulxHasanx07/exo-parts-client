        ...
        <div className="hero min-h-[90vh]" style={{backgroundImage:`url('https://raw.githubusercontent.com/SamiulxHasanx07/exo-parts-images/main/banner/banner-bg.png')`}}>
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div>
                    ...
                    <p className="py-6 text-left text-white">We happy to announce the next year   Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
