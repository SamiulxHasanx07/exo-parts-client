        ...
        <footer className='bg-primary'>
            <div className="footer p-10 text-base-content container mx-auto">
                <div>
                    ...
                    <Link to='' className="link link-hover">Bike Parts</Link>
                    <Link to='' className="link link-hover">Electrical Car Parts</Link>
                    <Link to='' className="link link-hover">Mobil</Link>
                </div>
                <div>
                    <span className="footer-title text-white">Our Delar Point</span>
            ...
            <div className="bg-secondary">
                <p className='text-white py-5 text-center'>All right reserved &copy; by Exo Parts 2022</p>
            </div>
        </footer>
    );
};
